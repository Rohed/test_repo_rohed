...
SELECT  
'Directive Consulting' as account,
...
lower(source) source,
lower(medium) medium,
(cast(goal5completions as INT64) + cast(goal17completions as INT64)) warm_goal_completions,
(cast(goal10completions as INT64) + cast(goal13completions as INT64)) hot_goal_completions,
users,
sessions,
...
FROM `agency-data-pipeline-185318.ga_directive.report` 
) 
